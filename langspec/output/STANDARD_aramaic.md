# Imperial Aramaic Programming Language Standard

**ILM / Hindawi Programming System — Per-Language Programming Standard**

**Copyright © 1993-2026 Abhishek Choudhary**

- **Human language**: Imperial Aramaic
- **ISO 639 code**: arc
- **Script**: Imperial Aramaic
- **Native speakers**: historical (Achaemenid lingua franca)
- **Constructs covered**: 201 of 201
- **Generated**: 2026-05-31

## What this standard defines

This document defines the Imperial Aramaic-language keyword set for programming across all major paradigms, together with the **Romenagri** ASCII-7 identifier form for each keyword. The Romenagri form is reversible, case-independent, diacritic-free, and legal as a C identifier — which means a compiler or lexer can accept the Imperial Aramaic keyword directly, in native script, and map it deterministically to the ASCII-7 form for the toolchain.
...
| Construct | English | Imperial Aramaic | Romenagri (ASCII-7) | Category |
|---|---|---|---|---|
...
| `KW_BEGIN` | begin | 𐡔𐡓𐡉 | `sharii` | block |
| `KW_END` | end | 𐡎𐡅𐡐 | `suupa` | block |

### Paradigm: imperative

| Construct | English | Imperial Aramaic | Romenagri (ASCII-7) | Category |
|---|---|---|---|---|
| `KW_IF` | if | 𐡄𐡍 | `hana` | control_flow |
| `KW_ELSE` | else | وإلا | `vaillaa` | control_flow |
| `KW_ELIF` | elif | وإلاإذا | `vaillaaizaa` | control_flow |
| `KW_WHILE` | while | طالما | `taalamaa` | control_flow |
| `KW_DO` | do | 𐡏𐡁𐡃 | `aebada` | control_flow |
| `KW_FOR` | for | لكل | `likulli` | control_flow |
...
| `KW_RETURN` | return | أرجع | `arjie` | control_flow |
| `KW_GOTO` | goto | اذهب | `izhaba` | control_flow |
| `KW_VAR` | var | متغير | `mutaghayyira` | declaration |
...
| `KW_TRUE` | true | 𐡒𐡔𐡈 | `qashata` | literal |
| `KW_FALSE` | false | خطأ | `khataa` | literal |
...
| `KW_NOT` | not | 𐡋𐡀 | `laa` | operator |
| `KW_AND` | and | 𐡅 | `va` | operator |
| `KW_OR` | or | 𐡀𐡅 | `aua` | operator |
...
| Construct | English | Imperial Aramaic | Romenagri (ASCII-7) | Category |
|---|---|---|---|---|
| `KW_CLASS` | class | صنف | `sanfa` | type_def |
...
| Construct | English | Imperial Aramaic | Romenagri (ASCII-7) | Category |
|---|---|---|---|---|
| `KW_FUNC` | function | دالة | `daalah` | subroutine |
