# Syriac Programming Language Standard

**ILM / Hindawi Programming System — Per-Language Programming Standard**

**Copyright © 1993-2026 Abhishek Choudhary**

- **Human language**: Syriac
- **ISO 639 code**: syr
- **Script**: Syriac (Estrangela)
- **Native speakers**: liturgical (Syriac Christianity)
- **Constructs covered**: 201 of 201
- **Generated**: 2026-05-31

## What this standard defines

This document defines the Syriac-language keyword set for programming across all major paradigms, together with the **Romenagri** ASCII-7 identifier form for each keyword. The Romenagri form is reversible, case-independent, diacritic-free, and legal as a C identifier — which means a compiler or lexer can accept the Syriac keyword directly, in native script, and map it deterministically to the ASCII-7 form for the toolchain.
...
| Construct | English | Syriac | Romenagri (ASCII-7) | Category |
|---|---|---|---|---|
...
| `KW_BEGIN` | begin | ܫܪܝ | `sharii` | block |
| `KW_END` | end | ܫܠܡ | `shalama` | block |

### Paradigm: imperative

| Construct | English | Syriac | Romenagri (ASCII-7) | Category |
|---|---|---|---|---|
| `KW_IF` | if | ܐܢ | `ana` | control_flow |
| `KW_ELSE` | else | ܐܚܪܢܐ | `aharanaa` | control_flow |
| `KW_ELIF` | elif | وإلاإذا | `vaillaaizaa` | control_flow |
| `KW_WHILE` | while | ܟܡܐ | `kamaa` | control_flow |
| `KW_DO` | do | ܥܒܕ | `aebada` | control_flow |
...
| `KW_RETURN` | return | ܦܢܐ | `panaa` | control_flow |
...
| `KW_TRUE` | true | ܫܪܪܐ | `sharaaraa` | literal |
| `KW_FALSE` | false | ܕܓܠܐ | `dagaalaa` | literal |
...
| `KW_NOT` | not | ܠܐ | `laa` | operator |
| `KW_AND` | and | ܘ | `va` | operator |
| `KW_OR` | or | ܐܘ | `aua` | operator |
